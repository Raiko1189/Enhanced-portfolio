                                ...
                                {category.skills.map((skill, skillIndex) => (
                                    <div key={skill.name}>
                                        <div className="flex justify-between items-center mb-2">
                                            <div className="flex items-center gap-3 text-gray-300 group-hover:text-red-400 transition-colors">
                                                <skill.icon size={20} />
                                        ...
                                        <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                                            <motion.div
                                                ...
                                                className="h-full bg-gradient-to-r from-red-500 to-sky-500"
                                            />
                                        </div>
                                    </div>
                                ))}
