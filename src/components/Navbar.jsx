            ...
            <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                ...
                >
                    <a href="#home" className="flex items-center gap-2">
                        <span className="w-8 h-8 bg-red-500 rounded-lg"></span>
                        <span>REIKO</span>
                    </a>
                </motion.div>
                    ...
                    <ul className="flex gap-8">
                        {navLinks.map((link, index) => (
                            ...
                            >
                                <a
                                    href={link.href}
                                    className="text-sm font-medium text-gray-400 hover:text-red-400 transition-colors uppercase tracking-widest"
                                >
                                    {link.name}
                                </a>
                            </motion.li>
                        ...
                        <ul className="flex flex-col p-6 gap-4">
                            {navLinks.map((link) => (
                                <li key={link.name}>
                                    <a
                                        href={link.href}
                                        className="text-lg font-medium text-gray-400 hover:text-red-400 block py-2"
