    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 pt-20 flex flex-col items-center text-center z-10">
                ...
                >
                    <span className="px-4 py-1.5 rounded-full bg-red-500/10 border border-red-500/20 text-red-400 text-sm font-medium mb-6 inline-block">
                    ...
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold mb-6 tracking-tight leading-[1.1]">
                        <motion.span
                            ...
                            className="inline-block origin-bottom-right mr-2"
                        >
                            👋
                        </motion.span>
                        Hi, I'm <span className="text-gradient">Reiko Wakbeka</span> <br />
                        <div className="h-[1.2em] flex items-center justify-center overflow-hidden">
                            <AnimatePresence mode="wait">
                                <motion.span
                                    ...
                                    className="text-white inline-block text-3xl md:text-5xl lg:text-6xl"
                                >
                                    {roles[roleIndex]}
                                </motion.span>
                            </AnimatePresence>
                    ...
                    <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
                        Engineering high-performance, pixel-perfect digital experiences.
                        I transform complex problems into elegant, scalable web solutions that leave a lasting impression.
                    </p>
                </motion.div>
