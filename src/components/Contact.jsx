...
export default function Contact() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch("https://formsubmit.co/ajax/hirkowak123@gmail.com", {
                method: "POST",
                headers: {
    ...
    const socials = [
        { Icon: Github, link: "https://github.com/Raiko1189" },
        { Icon: Linkedin, link: "https://www.linkedin.com/in/reiko-wakbeka-33882a349/" },
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-6 p-4 glass-card border-none hover:bg-white/5 transition-colors">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:hirkowak123@gmail.com" className="text-white font-medium hover:text-red-500 transition-colors">
                                        hirkowak123@gmail.com
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-6 p-4 glass-card border-none hover:bg-white/5 transition-colors">
                                ...
                                <div>
                                    ...
                                    <p className="text-white font-medium">+251 996 82 95 18</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex gap-4">
                                {socials.map(({ Icon, link }, i) => (
                                    <a
                                        ...
                                        className="w-12 h-12 glass-card border-none flex items-center justify-center text-gray-400 hover:text-red-500 hover:bg-white/5 transition-all outline-none"
                                    >
                                        <Icon size={20} />
                                    </a>
                                ))}
                        ...
                        <form
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:border-red-500/50 outline-none transition-all"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:border-red-500/50 outline-none transition-all resize-none"
                            ...
                            {isSent && (
                                <div className="mt-6 p-4 rounded-xl bg-red-500/10 border border-red-500/20">
                                    <p className="text-red-500 font-bold mb-1">Message Sent Successfully!</p>
                                    <p className="text-red-400 text-sm">Thank you for reaching out. I will get back to you as soon as possible.</p>
                                </div>
                            )}
