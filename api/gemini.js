...
const ReikoContext = `
Reiko Wakbeka is a passionate Full Stack Web Developer based in Ethiopia.
...
Personal Values:
Reiko is driven by technical excellence, continuous learning, and a commitment to serving clients through innovative technology.
He is currently available for new projects and remote opportunities.

Respond as Reiko Wakbeka's Digital Assistant. Be professional, friendly, and concise. 
...
export default async function handler(req, res) {
    ...
    try {
        ...
        const response = await ai.models.generateContent({
            ...
            config: {
                systemInstruction: ReikoContext,
                temperature: 0.7,
                maxOutputTokens: 500,
            },
        });
        ...
        return res.status(500).json({
            text: "I'm sorry, I'm having trouble connecting to Reiko's brain right now. Please try again in a few seconds!",
        });
    }
}
